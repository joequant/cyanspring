...
public class PovSellTest extends SingleOrderStrategyTest {

	@Override
	protected ParentOrder createData() {
		ParentOrder order = new ParentOrder("0005.HK", OrderSide.Sell, 200000, 68.10, OrderType.Limit);
	...
	public void test() {
		...
		timePass(10000);
		assertChildOrder(ASK, 16800, true);
		...
		timePass(10000);
		assertChildOrder(ASK, 12800, true);
