...
public class IcebergBuyTest extends SingleOrderStrategyTest {

	@Override
	protected ParentOrder createData() {
		ParentOrder order = new ParentOrder("0005.HK", OrderSide.Buy, 200000, 68.5, OrderType.Limit);
	...
	public void test() {
		...
		timePass(10000);
		assertChildOrder(BID, order.get(Double.TYPE, OrderField.DISPLAY_QUANTITY.value()), true);
